...
def save_survey_answers(entry_id: str, model_id: int, answers: dict, student_id: str):
    ...
    # print(f"answers es: {answers}")

    # -- Paso 5: A partir de aqui rige la lógica de Pablo
    ...
    return Answers(entry_id=answers_register.entry_id, answer_dict=answers_register.answer_dict)
